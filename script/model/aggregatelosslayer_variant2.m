classdef aggregatelosslayer_variant2 < nnet.layer.ClassificationLayer
    properties
        timeMat
        timeInt = [];
    ...
    methods
        function layer = aggregatelosslayer_variant2(name,timeMat,varargin)
...
%             intNum = max(poissrnd(12),5);
            ...
            l = getAggregateTrendLoss_variant2(timeTransMat_l,Y,'w',layer.w);    
